...
class Profile(val user: User,
    ...
    companion object {
        const val clockIconUrl = "https://cdn.pixabay.com/photo/2013/07/13/13/24/clock-160966_960_720.png"

        private val githubUrlRegex = Regex("https://github\\.com/(\\S+)/?")
        private val twitchUrlRegex = Regex("https://twitch\\.tv/(\\S+)/?")
