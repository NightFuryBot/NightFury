...
interface ISQLLevel<L> {
    fun hasLevel(guild: Guild, commandName: String): Boolean
    fun getLevel(guild: Guild, commandName: String, default: L): L
    fun setLevel(guild: Guild, commandName: String, level: L)
}