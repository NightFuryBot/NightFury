...
inline fun <reified M: Message> M.edit(block: () -> String): M = apply { editMessage(block()).queue() }
inline fun <reified M: Message> M.rebuild(block: MessageBuilder.() -> Unit): M = apply {
