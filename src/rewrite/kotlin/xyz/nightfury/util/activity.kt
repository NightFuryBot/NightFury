...
import net.dv8tion.jda.core.entities.Game as Activity
...
fun streaming(name: String, url: String): Activity {
    return if(Activity.isValidStreamingUrl(url)) Activity.streaming(name, url) else Activity.playing(name)
}
