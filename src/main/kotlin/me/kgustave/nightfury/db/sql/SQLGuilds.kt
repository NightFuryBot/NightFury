 ...
 */
abstract class SQLGuilds(private val connection: Connection, type: String)
{
...
class SQLMusicWhitelist(connection: Connection) : SQLGuilds(connection, "music")
class SQLBlacklist(connection: Connection) : SQLGuilds(connection, "blacklist")