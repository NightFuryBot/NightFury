...
class OrderedMenu(builder: OrderedMenu.Builder): Menu(builder) {
    companion object {
        val numbers: Array<String> = arrayOf("1\u20E3", "2\u20E3", "3\u20E3", "4\u20E3", "5\u20E3", "6\u20E3",
                                             "7\u20E3", "8\u20E3", "9\u20E3", "\uD83D\uDD1F")
    ...
    class Builder : Menu.Builder<OrderedMenu.Builder, OrderedMenu>() {
        ...
        infix inline fun description(lazy: () -> String?): OrderedMenu.Builder
            = apply { description = lazy() }
        infix inline fun text(lazy: () -> String?): OrderedMenu.Builder
            = apply { text = lazy() }
        infix inline fun useCancelButton(lazy: () -> Boolean): OrderedMenu.Builder
            = apply { useCancel = lazy() }
        infix inline fun color(lazy: () -> Color?): OrderedMenu.Builder
            = apply { color = lazy() }
        infix inline fun useLetters(lazy: () -> Boolean): OrderedMenu.Builder
            = apply { useLetters = lazy() }
        infix inline fun useNumbers(lazy: () -> Boolean): OrderedMenu.Builder
            = apply { useLetters = !lazy() }
        infix inline fun allowTextInput(lazy: () -> Boolean): OrderedMenu.Builder
